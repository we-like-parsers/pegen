...
from pegen.tokenizer import PythonTokenTypes, Tokenizer
...
) -> Tuple[Grammar, Parser[int], Tokenizer[int]]:
    with open(grammar_file) as file:
        tokenizer = Tokenizer(
            tokenize.generate_tokens(file.readline),  # type: ignore
            token_types=PythonTokenTypes(),
