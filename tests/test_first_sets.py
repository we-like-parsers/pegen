...
class TestFirstSets(unittest.TestCase):
    ...
    def test_repeat_with_separator(self) -> None:
        ...
        """
        self.assertEqual(
            self.calculate_first_sets(grammar), {"thing": {"NUMBER"}, "start": {"NUMBER"}}
        )
    ...
    def test_optional_after(self) -> None:
        ...
        """
        self.assertEqual(
            self.calculate_first_sets(grammar), {"term": {"NUMBER"}, "start": {"NUMBER"}}
        )
    ...
    def test_advance_left_recursion(self) -> None:
        ...
        """
        self.assertEqual(
            self.calculate_first_sets(grammar), {"sign": {"'-'", ""}, "start": {"'-'", "NUMBER"}}
        )
