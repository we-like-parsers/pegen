...
from story7.generator3 import check, generate
from story7.visualizer import Visualizer
...
def main():
    ...
    if not file:
        if args.regen:
            file = "story7/grammar.gram"
        else:
            file = "story7/toy.gram"
    outfile = args.output
    if not outfile:
    ...
    if args.backup:
        from story7.grammar import GrammarParser
    else:
